...
class View {
	 ...
	 *
	 * @param
	 *        	string variable name or an array of variables
	 * @param
	 *        	mixed value
	 * @param
	 *        	bool whether to filter the data or not
	 * @return void
	 */
	 ...
	 *
	 * @param
	 *        	bool whether to auto filter or not
	 * @return View
	 */
	 ...
	 * @param
	 *        	mixed The default value to return
	 * @return mixed
	 * @throws OutOfBoundsException
	 */
	 ...
	 * Assigned values will be available as a
	 ...
	 * The benefit of binding is that values can
	 ...
	 *        	mixed referenced variable
	 * @param
	 *        	bool Whether to filter the var on output
	 * @return $this
	 */
	 ...
	 * Global and local data are merged
