...
class Event_Instance {
	 ...
	 *        	string The name of the event
	 * @param
	 *        	mixed Any data that is to be passed to the listener
	 * @param
	 *        	string The return type
	 * @param
	 *        	boolean Wether to fire events ordered LIFO instead of FIFO
	 ...
	 * @param
	 *        	string	The name of the event
	 * @return bool the event has listeners
	 */
	 ...
	 * @access protected
	 * @param
	 *        	array	The array of returns
	 * @param
	 *        	string	The return type
	 * @return mixed formatted return
	 */
