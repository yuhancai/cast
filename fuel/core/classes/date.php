...
class Date {
	 ...
	 *
	 * @param
	 *        	int UNIX timestamp from current server
	 * @param
	 *        	string valid PHP timezone from www.php.net/timezones
	 * @return Date
	 */
	 ...
	 * @param
	 *        	string key name of pattern in config file
	 * @return Date
	 */
	 ...
	 *
	 * @param
	 *        	int|Date start of the range
	 * @param
	 *        	int|Date end of the range
	 * @param
	 *        	int|string Length of the interval in seconds or valid strtotime time difference
	 ...
	 *
	 * @param
	 *        	int month as a number (1-12)
	 * @param
	 *        	int the year, leave empty for current
	 ...
	 *        	int		UNIX timestamp from current server
	 * @param
	 *        	int		UNIX timestamp to compare against. Default to the current time
	 * @param
	 *        	string	Unit to return the result in
	 * @return string ago
	 */
	public static function time_ago($timestamp, $from_timestamp = null, $unit = null) {
		...
		$text = \Lang::get ( 'date.text', array (
				'time' => \Lang::get ( 'date.' . $periods [$j], array (
						't' => $difference 
				) ) 
		) );
	 ...
	 *
	 * @param
	 *        	string	either a named pattern from date config file or a pattern, defaults to 'local'
	 * @param
	 *        	mixed vald timezone, or if true, output the time in local time instead of system time
	 * @return string
	 */
	 ...
	 *
	 * @param
	 *        	string timezone from www.php.net/timezones
	 * @return Date
	 */
