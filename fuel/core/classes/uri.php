...
class Uri {
	 ...
	 *
	 * @param
	 *        	int segment number to start from. default value is the first segment
	...
	public static function create($uri = null, $variables = array(), $get_variables = array(), $secure = null) {
		...
		is_bool ( $secure ) and $url = http_build_url ( $url, array (
	 ...
	 *
	 * @param
	 *        	array|string Array or string to merge
	 * @param
	 *        	array|string ...
	 *        	
	 * @return string
