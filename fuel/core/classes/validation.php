...
class Validation {
	 ...
	 *
	 * @param
	 *        	string The name or instance of the Fieldset to link to
	 * @return Validation
	 */
	 ...
	 *        	string Field label
	 * @param
	 *        	string Rules as a piped string
	 ...
	 *
	 * @param
	 *        	string|Object Classname or object
	 * @return Validation this, to allow chaining
	 */
	...
	/*
	 * Remove Callable Removes an object from the callables array @param string|Object Classname or object @return Validation this, to allow chaining
	 */
	 ...
	 *
	 * @param
	 *        	array input that overwrites POST values
	 * @param
	 *        	bool will skip validation of values it can't find or are null
	 ...
	 *
	 * @param
	 *        	string|array short rule to be called on Validation callables array or full callback
	 ...
	 *        	callback
	 * @param
	 *        	mixed Value by reference, will be edited
	 * @param
	 *        	array Extra parameters
	 * @param
	 *        	array Validation field description
	...
	protected function _run_rule($rule, &$value, $params, $field) {
		...
		$output = call_fuel_func_array ( reset ( $rule ), array_merge ( array (
				$value 
		), $params ) );
	 ...
	 *        	string fieldname
	 * @param
	 *        	mixed value to return when not validated
	 ...
	 *
	 * @param
	 *        	array uses keys open_list, close_list, open_error, close_error & no_errors
	 * @return string
	 */
	 ...
	 *
	 * @param
	 *        	string				field name for which to set the error
	 * @param
	 *        	Validation_Error error for the field
	 * @return Validation this, to allow chaining
	 */
	 ...
	 *        	mixed
	 * @param
	 *        	bool whether to do type comparison
	 * @return bool
	 */
	...
	public function _validation_match_field($val, $field) {
		if ($this->input ( $field ) !== $val) {
			...
			throw new \Validation_Error ( $validating, $val, array (
					'match_field' => array (
							$field 
					) 
			), array (
	 ...
	 *        	string
	 * @param
	 *        	string|array either a named filter or combination of flags
	 * @return bool
	 */
	 ...
	 * When a format is passed
	 * it will make sure the date will be in that specific format if validated
	 *
	 * @param
	 *        	string
	 * @param
	 *        	string The format used at the time of a validation
	 * @param
	 *        	bool Whether validation checks strict
	 * @return bool
	 */
