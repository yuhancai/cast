...
class File {
	 ...
	 *
	 * @param
	 *        	string|File_Area|null file area name, object or null for base area
	 * @return File_Area
	 */
	 ...
	 *
	 * @param
	 *        	string directory where to create file
	 * @param
	 *        	string filename
	 * @param
	 *        	string|File_Area|null file area name, object or null for base area
	 ...
	 *
	 * @param
	 *        	string directory where to create new dir
	 * @param
	 *        	string dirname
	 * @param
	 *        	int (octal) file permissions
	 * @param
	 *        	string|File_Area|null file area name, object or null for non-specific
	 * @return bool
	 */
	public static function create_dir($basepath, $name, $chmod = null, $area = null) {
		...
		$new_dir = substr ( str_replace ( array (
				'\\',
				'/' 
		), DS, $new_dir ), strlen ( $basepath ) );
	 ...
	 *        	string file to read
	 * @param
	 *        	bool whether to use readfile() or file_get_contents()
	 * @param
	 *        	string|File_Area|null file area name, object or null for base area
	 ...
	 * @param
	 *        	int depth to recurse directory, 1 is only current and 0 or smaller is unlimited
	 * @param
	 *        	Array|null array of partial regexes or non-array for default
	 * @param
	 *        	string|File_Area|null file area name, object or null for base area
	 ...
	 *
	 * @param
	 *        	string directory where to write the file
	 * @param
	 *        	string filename
	 * @param
	 *        	string|File_Area|null file area name, object or null for base area
	 ...
	 *        	string path to the file or directory
	 * @param
	 *        	mixed file area name, object or null for base area
	 ...
	 *
	 * @param
	 *        	string path to file or directory to rename
	 * @param
	 *        	string new path (full path, can also cause move)
	 * @param
	 *        	string|File_Area|null source path file area name, object or null for non-specific
	 * @param
	 *        	string|File_Area|null target path file area name, object or null for non-specific. Defaults to source_area if not set.
	 * @return bool
	 */
	 ...
	 *
	 * @param
	 *        	string path to file to copy
	 * @param
	 *        	string new base directory (full path)
	 * @param
	 *        	string|File_Area|null source path file area name, object or null for non-specific
	 * @param
	 *        	string|File_Area|null target path file area name, object or null for non-specific. Defaults to source_area if not set.
	 ...
	 *
	 * @param
	 *        	string path to directory which contents will be copied
	 * @param
	 *        	string new base directory (full path)
	 * @param
	 *        	string|File_Area|null source path file area name, object or null for non-specific
	 ...
	 *
	 * @param
	 *        	string target of symlink
	 * @param
	 *        	string destination of symlink
	 * @param
	 *        	bool true for file, false for directory
	 * @param
	 *        	string|File_Area|null file area name, object or null for base area
	 * @return bool
	 */
	 ...
	 * @param
	 *        	bool whether to also delete contents of subdirectories
	 * @param
	 *        	bool whether to delete the parent dir itself when empty
	 * @param
	 *        	string|File_Area|null file area name, object or null for base area
	 * @return bool
	 */
	 ...
	 *
	 * @param
	 *        	resource|string file resource or path
	 * @param
	 *        	constant either valid lock constant or true=LOCK_EX / false=LOCK_UN
	 * @param
	 *        	string|File_Area|null file area name, object or null for base area
	 */
	 ...
	 *        	string file path
	 * @param
	 *        	string|null custom name for the file to be downloaded
	 * @param
	 *        	string|null custom mime type or null for file mime type
	 * @param
	 *        	string|File_Area|null file area name, object or null for base area
	 */
	public static function download($path, $name = null, $mime = null, $area = null) {
		...
		\Event::register ( 'fuel-shutdown', function () use($info, $area, $class) {
			...
			if (! $file = call_user_func ( array (
					$class,
					'open_file' 
			), @fopen ( $info ['realpath'], 'rb' ), LOCK_SH, $area )) {
