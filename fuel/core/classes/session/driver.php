...
abstract class Session_Driver {
	 ...
	 *
	 * @param
	 *        	string|array	name of the variable to set or array of values, array(name => value)
	 * @param
	 *        	mixed			value
	 * @access public
	 * @return Fuel\Core\Session_Driver
	 ...
	 * @param
	 *        	mixed	default value to return if the variable does not exist
	 * @return mixed
	 */
	 ...
	 * @access public
	 * @param
	 *        	string	name of the variable to get, default is 'session_id'
	 * @return mixed of the requested variable, or false if not found
	 */
	 ...
	 *
	 * @param
	 *        	string	name of the variable to delete
	 * @param
	 *        	mixed	value
	 * @access public
	 * @return Fuel\Core\Session_Driver
	 ...
	 * @access public
	 * @param
	 *        	boolean, if true, force a session id rotation
	 * @return Fuel\Core\Session_Driver
	 */
	...
	public function set_flash($name, $value) {
		...
		if ($keys) {
			...
			$this->flash [$this->config ['flash_id'] . '::' . $name] = array (
					'state' => 'new',
					'value' => $value 
			);
		}
	 ...
	 *        	mixed	default value to return if the variable does not exist
	 * @param
	 *        	bool	true if the flash variable needs to expire immediately, false to use "flash_auto_expire"
	 * @return mixed
	 */
	 ...
	 * @access public
	 * @param
	 *        	string	name of the variable to keep
	 * @return Fuel\Core\Session_Driver
	 */
	 ...
	 *
	 * @param
	 *        	string	name of the config variable to get
	 * @access public
	 * @return mixed
	 */
	 ...
	 *
	 * @param
	 *        	string	name of the config variable to set
	 * @access public
	 * @return Fuel\Core\Session_Driver
	 */
	...
	protected function _unserialize($input) {
		...
		elseif ($data === false) {
			is_string ( $input ) and $data = array (
					$input 
			);
		}
