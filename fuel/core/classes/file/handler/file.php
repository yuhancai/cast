...
class File_Handler_File {
	...
	/**
	 *
	 * @var bool the current object is read only
	 */
	 ...
	 *
	 * @param
	 *        	bool	whether to use file_get_contents() or readfile()
	 * @return string|IO
	 */
	 ...
	 *        	string			new filename
	 * @param
	 *        	string|false	new extension, false to keep current
	 * @return bool
	 */
	public function rename($new_name, $new_extension = false) {
		...
		$extension = $new_extension === false ? $info ['extension'] : ltrim ( $new_extension, '.' );
	 ...
	 *
	 * @param
	 *        	string	path to new directory, must be valid
	 * @return bool
	 */
	 ...
	 *
	 * @param
	 *        	string	path to target directory, must be valid
	 * @return bool
	 */
