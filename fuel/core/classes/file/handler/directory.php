...
class File_Handler_Directory {
	...
	/**
	 *
	 * @var array of files and directories within this directory
	 */
	 ...
	 *
	 * @param $dept whether
	 *        	not to read recursive
	 * @param $filters whether
	 *        	not to read recursive
	 * @return array
	 */
	 ...
	 *
	 * @param
	 *        	string	path to new parent directory, must be valid
	 * @return bool
	 */
	 ...
	 *
	 * @param
	 *        	string	path to parent directory, must be valid
	 * @return bool
	 */
