...
/**
 * The Autloader is responsible for all class loading.
...
class Autoloader {
	 ...
	 * Any class in the given namespace will be
	 ...
	 *
	 * @param
	 *        	array the namespaces
	 * @param
	 *        	bool whether to prepend the namespace to the search path
	 * @return void
	 */
	 ...
	 *
	 * @param
	 *        	string the namespace to get the path for
	 ...
	 * Any class added here will not be searched for
	 * but explicitly loaded from the path.
	 *
	 * @param
	 *        	string the class name
	 * @param
	 *        	string the path to the class file
	 * @return void
	 */
	 ...
	 *
	 * @param
	 *        	array the class names and paths
	 * @return void
	 */
