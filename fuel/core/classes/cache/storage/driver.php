...
abstract class Cache_Storage_Driver {
	 ...
	 */
	protected static $_gettable = array (
			'created',
			'expiration',
			'dependencies',
			'identifier' 
	 ...
	 */
	protected static $_settable = array (
			'expiration',
			'dependencies',
			'identifier' 
	);
	 ...
	 * Needs to set the object properties:
	 * - created
	 * - expiration
	 * - dependencies
	 * - contents
	 ...
	 * Needs to write the object properties:
	 * - created
	 * - expiration
	 * - dependencies
	 * - contents
	 ...
	 * @param
	 *        	array additional config values
	 */
	...
	final public function set($contents = null, $expiration = false, $dependencies = array()) {
		...
		$this->dependencies = (! is_array ( $this->dependencies )) ? array (
				$this->dependencies 
		) : $this->dependencies;
