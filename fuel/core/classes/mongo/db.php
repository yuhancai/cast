...
class Mongo_Db {
	 ...
	 * The $wheres array should
	 * be an associative array with the field as the key and the value as the search
	 * criteria.
	 *
	 * @param array $wheres
	 *        	array with conditions, array(field => value)
	 ...
	 *
	 * @param $flags Allows
	 *        	for the typical regular expression flags:
	 *        	i = case insensitive
	 *        	m = multiline
	 ...
	 *        	u = match unicode
	 *        	
	 * @param $enable_start_wildcard If
	 *        	set to anything other than TRUE, a starting line character "^" will be prepended
	 *        	to the search value, representing only searching for a value at the start of
	 *        	a new line.
	 *        	
	 * @param $enable_end_wildcard If
	 *        	set to anything other than TRUE, an ending line character "$" will be appended
	 ...
	 *        	name
	 * @param array $where
	 *        	of conditions, array(field => value)
	 * @param number $limit
	 *        	amount of documents to fetch
	 ...
	 *        	limit and skip information to the count function, if applicable.
	 ...
	 *        	name
	 * @param array $insert
	 *        	of values to insert, array(field => value)
	...
	public function insert($collection = '', $insert = array()) {
		...
		try {
			...
			$this->db->{$collection}->insert ( $insert, array (
					'fsync' => true 
			) );
	 ...
	 *        	name
	 * @param array $data
	 *        	array of values, array(field => value)
	 * @param array $options
	 *        	array of options
	...
	public function update($collection = '', $data = array(), $options = array(), $literal = false) {
		...
		try {
			...
			$this->db->{$collection}->update ( $this->wheres, (($literal) ? $data : array (
					'$set' => $data 
			)), $options );
	...
	public function delete($collection = '') {
		...
		try {
			...
			$this->db->{$collection}->remove ( $this->wheres, array (
					'fsync' => true,
					'justOne' => true 
			) );
	 ...
	 *        	name
	 * @param array $keys
	 *        	array of keys, array(field => direction)
	 * @param array $options
	 *        	array of options
