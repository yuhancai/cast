...
class Request {
	 ...
	 * The request is then set to be the active
	 ...
	 * @param
	 *        	mixed Internal: whether to use the routes; external: driver type or array with settings (driver key must be set)
	 * @param
	 *        	string request method
	 * @return Request The new request object
	 */
	public static function forge($uri = null, $options = true, $method = null) {
		is_bool ( $options ) and $options = array (
				'route' => $options 
		);
		is_string ( $options ) and $options = array (
				'driver' => $options 
		);
	 ...
	 *
	 * @param
	 *        	Request|null|false overwrite current request before returning, false prevents overwrite
	 * @return Request
	 */
	 ...
	 * @param
	 *        	bool whether or not to route the URI
	 * @param
	 *        	string request method
	 * @return void
	 */
	 ...
	 *
	 * @param array|null $method_params
	...
	public function execute($method_params = null) {
		...
		try {
			if ($this->route->callable !== null) {
				$response = call_fuel_func_array ( $this->route->callable, array (
						$this 
				) );
	 ...
	 *        	string the new path
	 * @param
	 *        	bool whether to add to the front or the back of the array
	 * @return void
	 */
