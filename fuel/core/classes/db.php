...
class DB {
	 ...
	 *
	 * @param
	 *        	integer type: DB::SELECT, DB::UPDATE, etc
	 * @param
	...
	/*
	 * Returns the last query @return	string	the last query
	 */
	...
	/*
	 * Returns the DB drivers error info @return	mixed	the DB drivers error info
	 */
	 ...
	 *
	 * @param
	 *        	mixed column name or array($column, $alias) or object
	 * @param
	 *        	...
	 ...
	 * @param
	 *        	array list of column names or array($column, $alias) or object
	 ...
	 *
	 * @param
	 *        	string table to get columns from
	 * @param
	 *        	string column to search for
	 * @param
	 *        	string the database connection to use
	 * @return array
	 */
	 ...
	 *
	 * @param
	 *        	mixed table name string or array(query, alias)
	 * @param
	 *        	string db connection
	 * @return integer
	 */
