 ...
 * Provides additional formatting methods for working with
 * numeric values.
 *
...
class Num {
	 ...
	 * @param
	 *        	string the mask format
	 * @param
	 *        	string a string (defaults to a single space) containing characters to ignore in the format
	 ...
	 * @link http://snippets.symfony-project.org/snippet/157
	 * @param
	 *        	string the unformatted phone number to format
	 * @param
	 *        	string the format to use, defaults to '(000) 000-0000'
	 ...
	 *
	 * @param
	 *        	string the unformatted expiration string to format
	 * @param
	 *        	string the format to use, defaults to '00-00'
	 * @see format
	 */
	 ...
	 *
	 * @param
	 *        	string the unformatted credit card number to format
	 * @param
	 *        	string the format to use, defaults to '**** **** **** 0000'
	 * @see mask_string
	 */
