...
class Html {
	 ...
	 * @param
	 *        	bool	true to force https, false to force http
	...
	public static function anchor($href, $text = null, $attr = array(), $secure = null) {
		if (! preg_match ( '#^(\w+://|javascript:|\#)# i', $href )) {
			...
			$href = http_build_url ( $href, array (
	 ...
	 *        	string	the subject
	 * @param
	 *        	array	attributes for the tag
	 * @return string javascript code containg email
	 */
	 ...
	 *
	 * @param
	 *        	string|array	multiple inputs or name/http-equiv value
	 * @param
	 *        	string			content value
	 * @param
	 *        	string			name or http-equiv
	 * @return string
	 */
	public static function meta($name = '', $content = '', $type = 'name') {
		if (! is_array ( $name )) {
			$result = html_tag ( 'meta', array (
					$type => $name,
					'content' => $content 
			) );
	 ...
	 *
	 * @param
	 *        	string	doctype declaration key from doctypes config
	 * @return string
	 */
	 ...
	 *
	 * @param
	 *        	string|array	one or multiple audio sources
	 * @param
	 ...
	 *
	 * @param
	 *        	array			list items, may be nested
	 * @param
	 *        	array|string	outer list attributes
	 * @return string
	 */
