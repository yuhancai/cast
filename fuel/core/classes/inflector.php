...
class Inflector {
	 ...
	 * @param string $str
	 *        	string to translate
	 * @param bool $allow_non_ascii
	 *        	wether to remove non ascii
	 ...
	 *        	wether to convert to lowercase
	 * @param bool $allow_non_ascii
	 *        	wether to allow non ascii
	 ...
	 *        	string the word
	 * @param
	 *        	string the separator (either _ or -)
	 * @param
	 *        	bool lowercare string and upper case first
	 ...
	 *        	string the table name
	 * @param
	 *        	bool whether to singularize the table name or not
	 ...
	 * @param
	 *        	string the class name
	 * @param bool $use_underscore
	 *        	to use an underscore or not
