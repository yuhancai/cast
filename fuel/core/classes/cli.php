...
class Cli {
	...
	public static function prompt() {
		...
		if (empty ( $input ) and $required === true) {
			...
			$input = forward_static_call_array ( array (
					__CLASS__,
					'prompt' 
			), $args );
		}
	 ...
	 * If you send an array it will implode them
	 * with a line break.
	 *
	 * @param string|array $text
	 *        	to output, or array of lines
	 */
	 ...
	 *
	 * @param
	 *        	integer	Number of lines to output
	 * @return void
	 */
...
fwrite ( STDOUT, chr ( 27 ) . "[H" . chr ( 27 ) . "[2J" );
	 ...
	 *        	background color
	 * @param string $format
	 *        	to apply. Currently only 'underline' is understood
