...
class Crypt {
	...
	/*
	 * Crypto object used to encrypt/decrypt @var	object
	 */
	private static $crypter = null;
	
	/*
	 * Hash object used to generate hashes @var	object
	 */
	private static $hasher = null;
	
	/*
	 * Crypto configuration @var	array
	 */
	...
	/*
	 * encrypt a string value, optionally with a custom key @param	string	value to encrypt @param	string	optional custom key to be used for this encryption @access	public @return	string	encrypted value
	 */
	...
	/*
	 * decrypt a string value, optionally with a custom key @param	string	value to decrypt @param	string	optional custom key to be used for this encryption @access	public @return	string	encrypted value
	 */
