...
class Upload {
	 ...
	 *
	 * @return bool if static:$files contains uploaded files that are valid
	 */
	 ...
	 *
	 * @return array of uploaded files that are validated
	 */
	 ...
	 *
	 * @return array of uploaded files that failed to validate
	 */
	 ...
	 *
	 * @param
	 *        	mixed	if int, $files element to move. if array, list of elements to move, if none, move all elements
	 * @param
	 *        	string	path to move to
	 * @return void
	 */
