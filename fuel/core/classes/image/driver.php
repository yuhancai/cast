...
abstract class Image_Driver {
	...
	/**
	 * Exectues the presets set in the config.
	 ...
	 *        	if it should return the images data, or just "$this".
	 * @param mixed $force_extension
	 *        	if it should force the extension witht this (or false)
	 * @return Image_Driver
	 */
	 ...
	 *
	 * @param string $filename        	
	 * @param boolean $writevar
	 *        	if the extension should be written to $this->image_extension
	 * @param mixed $force_extension
	 *        	if the extension should be overridden with this (or false)
	 * @return boolean
	 */
