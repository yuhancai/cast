...
class Input {
	 ...
	 *
	 * @param
	 *        	string	the default to return on failure
	 * @param
	 *        	bool	exclude private and reserved IPs
	...
	public static function protocol() {
		if (static::server ( 'HTTPS' ) == 'on' or static::server ( 'HTTPS' ) == 1 or static::server ( 'SERVER_PORT' ) == 443 or (\Config::get ( 'security.allow_x_headers', false ) and static::server ( 'HTTP_X_FORWARDED_PROTO' ) == 'https') or (\Config::get ( 'security.allow_x_headers', false ) and static::server ( 'HTTP_X_FORWARDED_PORT' ) == 443)) {
			return 'https';
		}
