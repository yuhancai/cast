...
abstract class ViewModel {
	...
	public static function forge($viewmodel, $method = 'view', $auto_filter = null, $view = null) {
		...
		$viewmodel = \Inflector::words_to_upper ( str_replace ( array (
				'/',
				DS 
		), '_', strpos ( $viewmodel, '.' ) === false ? $viewmodel : substr ( $viewmodel, 0, - strlen ( strrchr ( $viewmodel, '.' ) ) ) ) );
	 ...
	 *
	 * @param
	 *        	null|bool change setting (bool) or get the current setting (null)
