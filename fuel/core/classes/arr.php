...
class Arr {
	...
	public static function pluck($array, $key, $index = null) {
		...
		if (! $index) {
			...
			foreach ( $array as $i => $a ) {
				...
				$return [$i] = (is_object ( $a ) and ! ($a instanceof \ArrayAccess)) ? $a->{$key} : ($get_deep ? static::get ( $a, $key ) : $a [$key]);
			}
		}
	 ...
	 * @param
	 *        	string what to glue the keys together with
	 * @param
	 *        	bool whether to reset and start over on a new array
	 * @param
	 *        	bool whether to flatten only associative array's, or also indexed ones
	 * @return array
	 */
	 ...
	 * @param
	 *        	string prefix to filter on.
	 * @param
	 *        	bool whether to remove the prefix.
	 * @return array
	 */
	 ...
	 *        	array the array to filter.
	 * @param
	 *        	callback the callback that determines whether or not a value is filtered
	 * @return array
	 */
	 ...
	 *        	array the array to filter.
	 * @param
	 *        	string suffix to filter on.
	 * @param
	 *        	bool whether to remove the suffix.
	 * @return array
	 */
	 ...
	 *        	array the array to filter.
	 * @param
	 *        	array the keys to filter
	 * @param
	 *        	bool if true, removes the matched elements.
	 * @return array
	 */
	 ...
	 *
	 * @param
	 *        	array the original array (by reference)
	 * @param
	 *        	array|mixed the value(s) to insert, if you want to insert an array it needs to be in an array itself
	 * @param
	 *        	int the numeric position at which to insert, negative to count from the end backwards
	 ...
	 *        	array|mixed the value(s) to insert, if you want to insert an array it needs to be in an array itself
	 * @param
	 *        	string|int the key before which to insert
	 * @param
	 *        	bool wether the input is an associative array
	 ...
	 *        	array|mixed the value(s) to insert, if you want to insert an array it needs to be in an array itself
	 * @param
	 *        	string|int the key after which to insert
	 * @param
	 *        	bool wether the input is an associative array
	 * @return bool false when key isn't found in the array, otherwise true
	 */
	 ...
	 *        	array|mixed the value(s) to insert, if you want to insert an array it needs to be in an array itself
	 * @param
	 *        	string|int the value after which to insert
	 * @param
	 *        	bool wether the input is an associative array
	 ...
	 * @param
	 *        	string	The order (asc or desc)
	 * @param
	 *        	int		The php sort type flag
	 * @return array
	 */
	...
	public static function multisort($array, $conditions, $ignore_case = false) {
		...
		foreach ( $keys as $key ) {
			...
			is_array ( $conditions [$key] ) or $conditions [$key] = array (
					$conditions [$key] 
			);
		}
	 ...
	 *
	 * @param
	 *        	array			the array containing the key/value combinations
	 * @param
	 *        	array|string	key to replace or array containing the replacement keys
	 * @param
	 *        	string			the replacement key
	 ...
	 *
	 * @param
	 *        	array multiple variables all of which must be arrays
	 * @return array
	 * @throws \InvalidArgumentException
	 */
