...
class Cache {
	 ...
	 *
	 * @param
	 *        	mixed The identifier of the cache, can be anything but empty
	 * @param
	 *        	array|string Either an array of settings or the storage driver to be used
	...
	/**
	 * Front for writing the cache, ensures interchangebility of storage drivers.
	 * Actual writing
	 ...
	 * @param
	 *        	array Contains the identifiers of caches this one will depend on (not supported by all drivers!)
	 * @return Cache_Storage_Driver The new Cache object
	 */
	 ...
	 * @param
	 *        	array Arguements for the above function/method
	 * @param
	 *        	int Cache expiration in seconds
	 * @param
	 *        	array Contains the identifiers of caches this one will depend on (not supported by all drivers!)
	 * @return mixed
	 */
	...
	/**
	 * Front for reading the cache, ensures interchangebility of storage drivers.
	 * Actual reading
	...
	/**
	 * Frontend for deleting item from the cache, interchangable storage methods.
	 * Actual operation
