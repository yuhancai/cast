...
class Response {
	 ...
	 * @param array $headers
	 *        	Array of HTTP headers for this reponse
	 *        	
	 * @return Response
	 */
	 ...
	 * application.
	 * If not, it will redirect to the given url, and if none is
	 ...
	 * @param
	 *        	string Whether to replace existing value for the header, will never overwrite/be overwritten when false
	 *        	
	 * @return Response
	 */
	 ...
	 *
	 * @param
	 *        	string The header name, or null for all headers
	 *        	
	 * @return mixed
	 */
