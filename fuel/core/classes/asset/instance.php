...
class Asset_Instance {
	...
	public function __construct($config) {
		...
		foreach ( $config ['folders'] as $type => $folders ) {
			is_array ( $folders ) or $folders = array (
					$folders 
			);
	 ...
	 * @param
	 *        	string optional path type (js, css or img)
	 * @return object current instance
	 */
	 ...
	 * Each tag will be separated by a line break.
	 ...
	 *
	 * @param
	 *        	mixed the group to render
	 * @param
	 *        	bool whether to return the raw file or not
	 ...
	 * @access public
	 * @param
	 *        	mixed The file name, or an array files.
	 * @param
	 *        	array An array of extra attributes
	 * @param
	 *        	string The asset group name
	 ...
	 * @access public
	 * @param
	 *        	string	The filename to locate
	 * @param
	 *        	string	The sub-folder to look in (optional)
	 ...
	 *        	string	The path
	 * @param
	 *        	mixed	Optional directory separator
	 * @return string
	 */
