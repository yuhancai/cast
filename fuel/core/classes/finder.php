...
class Finder {
	...
	public static function instance() {
		if (! static::$instance) {
			static::$instance = static::forge ( array (
					APPPATH,
					COREPATH 
			) );
		}
	 ...
	 * It ensures that the path has a trailing
	 * Directory Separator.
	 *
	 * @param string $path
	 *        	The path to prepare
	 ...
	 * loaded search paths (e.g.
	 * the cascading file system). This is useful
	 * for things like finding all the config files in all the search paths.
	 *
	 * @param
	 *        	string The directory to look in
	 * @param
	 *        	string The file filter
	 ...
	 * @param
	 *        	array the data to cache (if non given it returns)
	 * @param
	 *        	int the number of seconds for the cache too live
	 */
