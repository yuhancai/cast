...
class Lang {
	 ...
	 *        	name of the language to load, null for the configurated language
	 ...
	 * @param string|null $language
	 *        	name of the language to get, null for the configurated language
	 ...
	 *        	group
	 * @param string|null $language
	 *        	name of the language to set, null for the configurated language
