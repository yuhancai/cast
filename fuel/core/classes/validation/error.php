...
class Validation_Error extends \Exception {
	 ...
	 *
	 * @param
	 *        	array Fieldset_Field object
	 * @param
	 *        	mixed value that failed to validate
	 * @param
	 *        	array contains rule name as key and callback as value
	 * @param
	 *        	array additional rule params
	 */
	 ...
	 *
	 * @param
	 *        	string HTML to prefix error message
	 * @param
	 *        	string HTML to postfix error message
	 * @param
	 *        	string Message to use, or false to try and load it from Lang class
	 * @return string
	 */
