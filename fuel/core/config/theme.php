...
return array (
		 ...
		 * This can also be set in code using Theme::active('foo');
		 */
		'active' => 'default',
		
		/**
		 * The fallback theme to use.
		 * If a view is not found in the active theme, this theme
		 ...
		 * They are searched in the order given. You can add paths
