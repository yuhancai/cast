...
class Test_Uri extends TestCase {
	...
	public function test_create() {
		...
		$output = Uri::create ( 'controller/:some', array (
				'some' => 'thing',
				'and' => 'more' 
		), array (
				'what' => ':and' 
		...
		$output = Uri::create ( 'http://example.com/controller/:some', array (
				'some' => 'thing',
				'and' => 'more' 
		), array (
				'what' => ':and' 
		...
		$output = Uri::create ( 'https://example.com/controller/:some', array (
				'some' => 'thing',
				'and' => 'more' 
		), array (
				'what' => ':and' 
	...
	public function test_build_query_string() {
		$output = Uri::build_query_string ( array (
				'varA' => 'varA' 
		), 'varB', array (
				'varC' => 'varC' 
		) );
	...
	public function test_update_query_string() {
		...
		$output = Uri::update_query_string ( array (
				'three' => 3 
		) );
