...
class Test_Form extends TestCase {
	...
	public function test_input_dont_prep() {
		$output = Form::input ( 'name', '&quot;&#39;H&amp;M&#39;&quot;', array (
				'dont_prep' => true 
		) );
		$expected = '<input name="name" value="&quot;&#39;H&amp;M&#39;&quot;" type="text" id="form_name" />';
		$this->assertEquals ( $expected, $output );
		
		$output = Form::input ( 'name', '', array (
				'dont_prep' => true 
		) );
		$expected = '<input name="name" value="" type="text" id="form_name" />';
		$this->assertEquals ( $expected, $output );
		
		$output = Form::input ( 'name', "0", array (
				'dont_prep' => true 
		) );
		$expected = '<input name="name" value="0" type="text" id="form_name" />';
		$this->assertEquals ( $expected, $output );
		...
		$output = Form::input ( 'name', 1, array (
				'dont_prep' => true 
		) );
		$expected = '<input name="name" value="1" type="text" id="form_name" />';
		$this->assertEquals ( $expected, $output );
		
		$output = Form::input ( 'name', 10, array (
				'dont_prep' => true 
		) );
		$expected = '<input name="name" value="10" type="text" id="form_name" />';
		$this->assertEquals ( $expected, $output );
		
		$output = Form::input ( 'name', true, array (
				'dont_prep' => true 
		) );
		$expected = '<input name="name" value="1" type="text" id="form_name" />';
		$this->assertEquals ( $expected, $output );
		
		$output = Form::input ( 'name', false, array (
				'dont_prep' => true 
		) );
		$expected = '<input name="name" value="" type="text" id="form_name" />';
		$this->assertEquals ( $expected, $output );
		
		$output = Form::input ( 'name', null, array (
				'dont_prep' => true 
		) );
		$expected = '<input name="name" value="" type="text" id="form_name" />';
		$this->assertEquals ( $expected, $output );
	...
	public function test_textarea_dont_prep() {
		$output = Form::textarea ( 'name', '&quot;&#39;H&amp;M&#39;&quot;', array (
				'dont_prep' => true 
		) );
		$expected = '<textarea name="name" id="form_name">&quot;&#39;H&amp;M&#39;&quot;</textarea>';
		$this->assertEquals ( $expected, $output );
	...
	public function test_select_prep() {
		$output = Form::select ( 'fieldname', null, array (
				'key_H&M' => 'val_H&M',
				'key_""' => 'val_""' 
		) );
		$expected = '<select name="fieldname" id="form_fieldname">' . PHP_EOL . '	<option value="key_H&amp;M">val_H&amp;M</option>' . PHP_EOL . '	<option value="key_&quot;&quot;">val_&quot;&quot;</option>' . PHP_EOL . '</select>';
		$this->assertEquals ( $expected, $output );
	}
