...
<meta name="keywords" content="fuel, rocks" />';
	...
	public function test_anchor() {
		...
		$output = Html::anchor ( 'http://google.com', 'Go to Google', array (
				'rel' => 'example',
				'class' => 'sample',
				'style' => 'color:red;' 
		) );
	...
	public function test_img() {
		...
		$output = Html::img ( 'image.png', array (
				'alt' => 'Image' 
		) );
	...
	public function test_lists() {
		...
		$output = Html::ul ( $list );
		$expected = '<ul>' . PHP_EOL . '	<li>one</li>' . PHP_EOL . '	<li>two</li>' . PHP_EOL . '</ul>' . PHP_EOL;
		$this->assertEquals ( $expected, $output );
		
		$output = Html::ol ( $list );
		$expected = '<ol>' . PHP_EOL . '	<li>one</li>' . PHP_EOL . '	<li>two</li>' . PHP_EOL . '</ol>' . PHP_EOL;
		$this->assertEquals ( $expected, $output );
	}
}
