...
class Test_Arr extends TestCase {
	...
	public function test_search_multi_array() {
		...
		$expected = 'one';
		$this->assertEquals ( $expected, Arr::search ( $arr_multi, array (
				'test' => 1 
		), null, false ) );
		$expected = null;
