...
class Session {
	...
	public static function run() {
		...
		$option = \Cli::prompt ( 'What would you like to do?', array (
				'create',
				'remove',
				'clear',
				'help' 
	...
	public static function create() {
		...
		if (\Config::get ( 'session.driver' ) != 'db') {
			...
			$continue = \Cli::prompt ( \Cli::color ( 'Your current driver type is not set db. Would you like to continue and add the sessions table anyway?', 'yellow' ), array (
					'y',
					'n' 
			) );
		...
		\DBUtil::create_table ( \Config::get ( 'session.db.table' ), array (
				...
				'session_id' 
		), false, 'InnoDB', \Config::get ( 'db.default.charset' ) );
	...
	public static function remove() {
		...
		// prompt the user to confirm they want to remove the table.
		$iamsure = \Cli::prompt ( 'Are you sure you want to delete the sessions table?', array (
				'y',
				'n' 
		) );
	...
	public static function clear() {
		...
		$iamsure = \Cli::prompt ( 'Are you sure you want to clear the sessions table?', array (
				'y',
				'n' 
		) );
