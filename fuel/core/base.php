 ...
 *
 * @param
 *        	int|string	the error level
 * @param
 *        	string	the error message
 * @param
 *        	string	information about the method
 * @return bool
 */
 ...
 *        	string			The tag name
 * @param
 *        	array|string	The tag attributes
 * @param
 *        	string|bool		The content to place in the tag, or false for no closing tag
 * @return string
 */
 ...
 *
 * @param
 *        	string	The view name/path
 * @param
 *        	array	The data for the view
 * @param
 *        	bool Auto filter override
 * @return string
 */
 ...
 * This is just a wrapper function for Security::htmlentities()
 *
 * @param
 *        	mixed	The string to encode
 * @return string
 */
 ...
 *
 * @param
 *        	mixed (Part(s) of) an URL in form of a string or associative array like parse_url() returns
 * @param
 *        	mixed Same as the first argument
 * @param
 *        	int A bitmask of binary or'ed HTTP_URL constants (Optional)HTTP_URL_REPLACE is the default
 * @param
 *        	array If set, it will be filled with the parts of the composed url like parse_url() would return
 *        	
 ...
 *
 * @param
 *        	array array with the paths to compare
 *        	
