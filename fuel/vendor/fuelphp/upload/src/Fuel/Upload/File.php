...
class File implements \ArrayAccess, \Iterator, \Countable {
	 ...
	 *
	 * @param array $file
	 *        	Array with unified information about the file uploaded
	 ...
	 *
	 * @param string $name
	 *        	name of the container item to get
	 *        	
	 ...
	 *
	 * @param string $name
	 *        	name of the container item to set
	 * @param mixed $value
	 *        	value to set it to
	 */
	...
	/**
	 * Convert a filename into a normalized name.
	 * only outputs 7 bit ASCII characters.
	 *
	 * @return void
	 */
