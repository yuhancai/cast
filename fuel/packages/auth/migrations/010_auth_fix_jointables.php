...
class Auth_Fix_Jointables {
	...
	function down() {
		...
		if (in_array ( 'Ormauth', $drivers )) {
			...
			\DBUtil::create_index ( $basetable . '_user_permissions', array (
					'user_id',
					'perms_id' 
			), '', 'PRIMARY' );
			...
			\DBUtil::create_index ( $basetable . '_group_permissions', array (
					'group_id',
					'perms_id' 
			), '', 'PRIMARY' );
			...
			\DBUtil::create_index ( $basetable . '_role_permissions', array (
					'role_id',
					'perms_id' 
			), '', 'PRIMARY' );
		}
