...
class Auth_Create_Oauth2tables {
	function up() {
		...
		\DBUtil::create_table ( $basetable . '_clients', array (
				...
				'status' => array (
						'type' => 'enum',
						'constraint' => '"development","pending","approved","rejected"',
						'default' => 'development' 
				),
				'suspended' => array (
						'type' => 'tinyint',
		...
		\DBUtil::create_table ( $basetable . '_sessions', array (
				'id' => array (
						'type' => 'int',
						'constraint' => 11,
						'auto_increment' => true 
				...
				'stage' => array (
						'type' => 'enum',
						'constraint' => '"request","granted"',
						'default' => 'request' 
				),
				'first_requested' => array (
						'type' => 'int',
						'constraint' => 11 
				),
				'last_updated' => array (
		...
		\DBUtil::create_table ( $basetable . '_sessionscopes', array (
				'id' => array (
						'type' => 'int',
						'constraint' => 11,
						'auto_increment' => true 
