...
class Auth {
	...
	/**
	 *
	 * @var Auth_Login_Driver instance
	 */
	 ...
	 *
	 * @param
	 *        	Array settings for the new driver
	 ...
	 *
	 * @param
	 *        	string driver id or null for default driver
	 ...
	 *
	 * @param
	 *        	string|Array specific driver or drivers, in this case it will always terminate after first success
	 * @return bool
	 */
	 ...
	 *
	 * @param
	 *        	null|string driver id or null for all verified driver in an array
	 ...
	 *
	 * @param
	 *        	string name of the driver type, may not conflict with class method name
	 * @param
	 *        	string name of the method to use for checking this type of driver, also cannot conflict with method
	 * @return bool
	 */
	public static function register_driver_type($type, $check_method) {
		$driver_exists = ! is_string ( $type ) || array_key_exists ( $type, static::$_drivers ) || method_exists ( get_called_class (), $check_method ) || in_array ( $type, array (
				'login',
				'group',
				'acl' 
		) );
		$method_exists = ! is_string ( $type ) || array_search ( $check_method, static::$_drivers ) || method_exists ( get_called_class (), $type );
	 ...
	 *
	 * @param
	 *        	string name of the driver type
	 * @return bool
	 */
	 ...
	 *        	string driver type
	 * @param
	 *        	string|true driver id or true for an array of all loaded drivers
	 ...
	 *        	string driver type
	 * @param
	 *        	mixed condition for which the driver is checked
	 * @param
	 *        	string driver id or null to check all
	 * @param
	 *        	Array identifier to check, should default to current user or relation therof and be
