...
print_r($this->getAllDataFromUrl("http://1.163.com/detail/01-37-00-00-05.html"));
		
	
		
        
		
/* 		$arrInfo=Model_Item::getInfoFromUrl("http://1.163.com/detail/01-37-00-00-04.html");
...
/////////
   ...
   public function getAllDataFromUrl($url=null)
   {
   	...
   	//if id don't exsit insert add this 
   	$drawid=Model_draw::getMaxQishuByItemid($id);//get qishu id
